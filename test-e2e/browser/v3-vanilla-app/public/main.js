...
var authorsSearch = new dataProvider.SelectorV3(authorsProvider, function (query, authorsResults) {
...
var booksWithAuthorName = new dataProvider.SelectorV3([authorsProvider, booksProvider], function (
  query,
  results
) {
...
var booksSearch = new dataProvider.SelectorV3(booksWithAuthorName, function (query, booksResults) {
  if (!query.search.length) {
    return [];
  }
...
var authorBooks = new dataProvider.SelectorV3(booksProvider, function (query, booksResults) {
  return booksResults.filter(function (book) {
